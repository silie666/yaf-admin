...
layui.use(["element", "form", "layer", "okUtils", "okTab", "okLayer", "okContextMenu", "okHoliday", "laydate","okFly"], function () {
	...
	$("#alertSkin").click(function () {
		okLayer.open("皮肤动画", "/admin/System/alert_skin", "50%", "45%", function (layero) {
		}, function () {
		});
	});
	...
	function lockShowInit(okUtils) {
		...
		form.on('submit(lockSubmit)', function (data) {
			...
			$.get("/admin/User/check_pass",{ password : data.field.lock_password}, function(data){
