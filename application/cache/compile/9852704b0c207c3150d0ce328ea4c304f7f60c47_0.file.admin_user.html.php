...
function content_5febfab25585c0_73711862 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            cols: [[
                ...
                {title: "操作",  fixed: "right", templet:function (item) {
                        if(item.id != 1){
                            let str = ''
                            if(item.user_status == 1){
                                str = '  <button type="button" class="layui-btn layui-btn-danger layui-btn-xs" id="update_status" data-status="0" data-id="'+item.id+'">停用</button>'
                            }else{
                                str = '  <button type="button" class="layui-btn  layui-btn-xs" id="update_status" data-status="1" data-id="'+item.id+'">启用</button>'
                            }
