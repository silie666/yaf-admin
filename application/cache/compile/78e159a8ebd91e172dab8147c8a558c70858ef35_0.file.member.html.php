...
function content_5fed47a6ecce89_03685670 (Smarty_Internal_Template $_smarty_tpl) {
...
,
        ...
        $('body').on('click',"#forbid_publish",function () {
            ...
            let url  = `/admin/User/member_status?${encodeSearchParams(obj)}`;
